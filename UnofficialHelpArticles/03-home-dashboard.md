...
> 💡 **Tip:** The home view displays Quick Links in read-only mode. To add, edit, or reorder links, navigate to **Utilities → Quick Links**. See the [Quick Links](olio://help/quick-links) article for full details.
