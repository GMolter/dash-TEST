      ...
      <div className="mx-auto max-w-xl rounded-2xl border border-slate-700 bg-slate-900/90 p-6 shadow-2xl sm:p-8">
        ...
        {state === 'waiting' && (
          <div className="mt-8 space-y-6">
            ...
            <div className="flex gap-3 text-sm text-slate-300"><ShieldCheck className="mt-0.5 h-5 w-5 flex-none text-emerald-300" /><p>Approval creates one revocable device credential for connection status and read-only access to your private Quick Pastes. The launcher cannot create, edit, delete, reorder, favorite, or share your data.</p></div>
