...
Both were applied to OlioDashboard through its SQL editor on September 22, 2026. The live Organization page was refreshed and verified to load announcements, resources, and activity without missing-table errors. These manually applied scripts are not recorded automatically in Supabase CLI migration history; reconcile the history before a future CLI push instead of rerunning the table-creation migration.
