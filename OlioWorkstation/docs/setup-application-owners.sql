...
-- Installs owner protection and the review workflow before assigning owners.
begin;
...
select id, email, app_owner, app_admin from public.profiles where app_owner = true;
